...
\input{./text-zh/pgfmanual-zh-main/pgfmanual-zh-introduction}
...
\input{./text-zh/pgfmanual-zh-tutorial/pgfmanual-zh-tutorial}
\input{./text-zh/pgfmanual-zh-tutorial/pgfmanual-zh-tutorial-nodes}
\input{./text-zh/pgfmanual-zh-tutorial/pgfmanual-zh-tutorial-Euclid}
\input{./text-zh/pgfmanual-zh-tutorial/pgfmanual-zh-tutorial-chains}
\input{./text-zh/pgfmanual-zh-tutorial/pgfmanual-zh-tutorial-map}
\input{./text-zh/pgfmanual-zh-tutorial/pgfmanual-zh-guidelines}
...
\input{./text-zh/pgfmanual-zh-installation/pgfmanual-zh-installation}
\input{./text-zh/pgfmanual-zh-installation/pgfmanual-zh-license}
\input{./text-zh/pgfmanual-zh-installation/pgfmanual-zh-drivers}
...
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-design}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-scopes}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-coordinates}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-paths}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-actions}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-arrows}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-shapes}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-pics}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-graphs}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-matrices}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-trees}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-plots}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-transparency}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-decorations}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-transformations}
\input{./text-zh/pgfmanual-zh-tikz/pgfmanual-zh-tikz-animations}
...
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-overview}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-usage-tikz}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-usage-pgf}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-trees}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-layered}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-force}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-circular}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-phylogenetics}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-edge-routing}
%
% XXX : disabled because of
% 1. compile-time dependencies which are hard to resolve
% 2. it is "hardly usable anyway" (TT)
%\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-ogdf}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-algorithm-layer}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-algorithms-in-c}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-display-layer}
\input{./text-zh/pgfmanual-zh-gd/pgfmanual-zh-gd-binding-layer}
...
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-3d}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-angles}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-arrows}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-automata}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-babel}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-backgrounds}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-bbox}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-calc}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-calendar}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-chains}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-circuits}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-decorations}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-er}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-external}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-fadings}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-fit}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-fixedpoint}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-fpu}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-lsystems}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-math}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-matrices}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-mindmaps}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-folding}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-patterns}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-perspective}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-petri}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-plot-handlers}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-plot-marks}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-profiler}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-rdf}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-shadings}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-shadows}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-shapes}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-spy}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-svg-path}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-edges}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-through}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-trees}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-turtle}
\input{./text-zh/pgfmanual-zh-library/pgfmanual-zh-library-views}
...
\input{./text-zh/pgfmanual-zh-dv/pgfmanual-zh-dv-introduction}
\input{./text-zh/pgfmanual-zh-dv/pgfmanual-zh-dv-main}
\input{./text-zh/pgfmanual-zh-dv/pgfmanual-zh-dv-formats}
\input{./text-zh/pgfmanual-zh-dv/pgfmanual-zh-dv-axes}
\input{./text-zh/pgfmanual-zh-dv/pgfmanual-zh-dv-visualizers}
\input{./text-zh/pgfmanual-zh-dv/pgfmanual-zh-dv-stylesheets}
\input{./text-zh/pgfmanual-zh-dv/pgfmanual-zh-dv-polar}
\input{./text-zh/pgfmanual-zh-dv/pgfmanual-zh-dv-backend}
...
\input{./text-zh/pgfmanual-zh-utilities/pgfmanual-zh-pgfkeys}
\input{./text-zh/pgfmanual-zh-utilities/pgfmanual-zh-pgffor}
\input{./text-zh/pgfmanual-zh-utilities/pgfmanual-zh-pgfcalendar}
\input{./text-zh/pgfmanual-zh-utilities/pgfmanual-zh-pages}
\input{./text-zh/pgfmanual-zh-utilities/pgfmanual-zh-xxcolor}
\input{./text-zh/pgfmanual-zh-utilities/pgfmanual-zh-module-parser}
...
\input{./text-zh/pgfmanual-zh-math/pgfmanual-zh-math-design}
\input{./text-zh/pgfmanual-zh-math/pgfmanual-zh-math-parsing}
\input{./text-zh/pgfmanual-zh-math/pgfmanual-zh-math-commands}
\input{./text-zh/pgfmanual-zh-math/pgfmanual-zh-math-algorithms}
\input{./text-zh/pgfmanual-zh-math/pgfmanual-zh-math-numberprinting}
\input{./text-zh/pgfmanual-zh-math/pgfmanual-zh-oo}
...
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-design}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-scopes}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-points}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-paths}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-decorations}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-actions}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-arrows}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-nodes}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-matrices}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-transformations}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-patterns}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-images}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-external}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-plots}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-layers}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-shadings}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-transparency}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-animations}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-internalregisters}
\input{./text-zh/pgfmanual-zh-base/pgfmanual-zh-base-quick}
...
\input{./text-zh/pgfmanual-zh-pgfsys/pgfmanual-zh-pgfsys-overview}
\input{./text-zh/pgfmanual-zh-pgfsys/pgfmanual-zh-pgfsys-commands}
\input{./text-zh/pgfmanual-zh-pgfsys/pgfmanual-zh-pgfsys-paths}
\input{./text-zh/pgfmanual-zh-pgfsys/pgfmanual-zh-pgfsys-protocol}
\input{./text-zh/pgfmanual-zh-pgfsys/pgfmanual-zh-pgfsys-animations}
