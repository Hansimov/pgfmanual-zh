...
\node [below right,text width= 4em, fill=red!30                 ] (rect red)   at (current bounding box.north west) {\textbf{尚未翻译}};
\node [below right,text width= 4em, yshift =  -5ex, fill=cyan!30] (rect cyan)  at (current bounding box.north west) {\textbf{正在翻译}};
\node [below right,text width= 4em, yshift = -10ex,fill=green!30] (rect green) at (current bounding box.north west) {\textbf{翻译完成}};
