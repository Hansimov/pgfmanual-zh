...
\tikzstyle{nd1} = [draw=black, minimum width=8em, text width=18em, align=center]
\tikzstyle{nd2} = [draw=black, minimum width=8em, text width=28em, align=left]
...
\node [below right,text width= 4em, yshift =  -5ex, doing ] at (current bounding box.north west) {\textbf{正在翻译}};
\node [below right,text width= 4em, yshift = -10ex, done  ] at (current bounding box.north west) {\textbf{翻译完成}};
