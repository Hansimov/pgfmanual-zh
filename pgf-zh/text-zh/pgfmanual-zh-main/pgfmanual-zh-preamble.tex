...
\usepackage[dvipsnames]{xcolor} % Added by Hansimov
...
\graphicspath{{./text-zh/images/}}              % TODOsp: under windows this would go up 2 directories, but the file is only one directory up
\input{./text-zh/pgfmanual-zh-main/pgfmanual-zh-macros}    % TODOsp: same here
