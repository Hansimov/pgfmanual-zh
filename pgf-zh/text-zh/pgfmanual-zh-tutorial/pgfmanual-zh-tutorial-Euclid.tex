...
\begin{tikzpicture}[thick,help lines/.style={thin,draw=black!50}]
  ...
  \node [below right,text width=10cm,align=justify] at (4,3)
  {
    ...
    \emph{在一个已知\textcolor{input}{有限直线}上做一个\textcolor{triangle}{等边三角形}.}
    \par
    \vskip1em
    ...
    设 \A\B\ 是已知\textcolor{input}{有限直线}.那么要求在\textcolor{input}{线段} \A\B\ 上作一个\textcolor{triangle}{等边三角形}.
    ...
    以 \A\ 为心，且以 \A\B\ 为距离画圆 \B\C\D ；再以 \B\ 为心，且以\B\A\ 为距离画圆 \A\C\E ；由两圆的交点 \C\ 到\A 、\B\ 连\textcolor{output}{线} \C\A 、\C\B .
    ...
    因为，点 \A\ 是圆 \C\D\B\ 的圆心，\A\C\ 等于 \A\B .
    又点 \B\ 是圆 \C\A\E\ 的圆心，\B\C\ 等于 \B\A .
    但是，已经证明了 \C\A\ 等于 \A\B；所以线段 \C\A\ 、\C\B\ 都等于 \A\B .
    而且等于同量的量彼此相等. 三条线段 \C\A 、\A\B 、\B\C\ 彼此相等.
    所以\textcolor{triangle}{三角形} \A\B\C\ 是等边的，即在已知有限\textcolor{input}{直线} \A\B\ 上作出了这个三角形.
  };
\end{tikzpicture}
\bigskip
...
\item \ltz{\\p}{\color{blue}\metazh{数字}} 得到 \ltz{\\x}{\color{blue}\metazh{数字}}\ltz{,\\y}{\color{blue}\metazh{数字}}。
\end{enumerate}
